...
- **Multi layered Liquidity:** Drift combines **DLOB resting orders, JIT liquidity, AMM reserves, and Swift routing** to maximize fill quality.  
- **Gasless + Fast Execution:** Through **Swift**, takers trade without paying gas, and makers receive orders instantly via websocket.
- **Competitive fees and rebates:** Reduced taker fees, maker rebates up to 40%, and priority access to Swift order flow.  
