...
⚠️ Note: This is a temporary workaround for using `@drift-labs/sdk`. The SDK includes imports for Node.js core modules like fs, which aren't available in browsers.

### Fix

Trying to import the SDK in a frontend app will trigger errors like:
